(function() {
  var PDFArray, PDFBoolean, PDFColor, PDFComment, PDFDateString, PDFDictionary, PDFDocument, PDFFillColor, PDFHeader, PDFImage, PDFName, PDFNull, PDFNumber, PDFObject, PDFPage, PDFPath, PDFRectangle, PDFReference, PDFScript, PDFStream, PDFString, PDFStrokeColor, PDFText, PDFTrailer, PDFXRef, PDFXRefEntry, PDFXRefSubsection;
  ...
  window.CoffeePDF = (function() {
    ...
    CoffeePDF.prototype.addScript = function(fn) {
      return this.script = new PDFScript(fn);
    };
    CoffeePDF.prototype.build = function() {
      ...
      }, this.documentProperties, this.pages, this.resources, this.script);
    };
    ...
    CoffeePDF.prototype.script = null;
    return CoffeePDF;
  })();
  PDFObject = (function() {
  ...
  PDFImage = (function() {
    ...
    PDFImage.prototype.streamString = function() {
      ...
      if (typeof this.imageData !== "string") {
        if (this.imageData.length / (this.size.width * this.size.height) === 4) {
        ...
        this.imageData = Crypto.charenc.Binary.bytesToString(this.imageData);
      }
      return new PDFStream(this.imageData);
    };
  ...
  PDFDocument = (function() {
    function PDFDocument(version, pageSize, properties, pageObjects, resources, script) {
      this.version = version;
    ...
    PDFDocument.prototype.addCatalog = function() {
      return this.addObject("catalog", new PDFDictionary({
        Names: new PDFDictionary({
          JavaScript: this.objectReferences.script
        }),
        Type: new PDFName("Catalog"),
        Pages: this.objectReferences.pageTable,
        OpenAction: new PDFArray([this.objectReferences.pageTable, new PDFName("FitH"), new PDFNull()]),
        PageLayout: new PDFName("OneColumn")
      }));
    };
    PDFDocument.prototype.addDocumentInformation = function() {
      return this.addObject("documentInformation", new PDFDictionary({
    ...
    PDFDocument.prototype.addTrailer = function() {
      return this.objects.push(new PDFTrailer(this.offsetSum, {
        ...
        Root: this.objectReferences.catalog,
        Info: this.objectReferences.documentInformation
      }));
    };
    ...
    PDFDocument.prototype.addScript = function() {
      if (this.script) {
        this.objects.push(this.script);
        return this.addObject("script", new PDFDictionary({
          Names: new PDFArray([new PDFString("0000000000000000"), new PDFReference(this.objects.length, 0)])
        }));
      }
    };
  ...
  PDFPage = (function() {
    function PDFPage() {
      PDFPage.__super__.constructor.apply(this, arguments);
    }
    __extends(PDFPage, PDFObject);
  ...
  PDFScript = (function() {
    __extends(PDFScript, PDFObject);
    function PDFScript(fn) {
      this.fn = fn;
    }
    PDFScript.prototype.dictionaryString = function() {
      return new PDFDictionary({
        S: new PDFName("JavaScript"),
        JS: new PDFString("" + (this.functionString()))
      });
    };
    PDFScript.prototype.functionString = function() {
      alert(this.fn.toString().slice(13, -1));
      return this.fn.toString().slice(13, -1);
    };
    PDFScript.prototype.toString = function() {
      return "" + (this.dictionaryString());
    };
    return PDFScript;
  })();
