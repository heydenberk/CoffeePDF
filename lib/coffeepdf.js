    ...
    jsPDF.prototype.create = function() {
      ...
      this.jsPDF = {
        ...
        text: __bind(function(x, y, text) {
          ...
          str = sprintf("BT %.2f %.2f Td (%s) Tj ET", x * this.scaleFactor, (this.pageSize.height - y) * this.scaleFactor, this.pdfEscape(text));
          this.out(str);
          return this.jsPDF;
        }, this),
        line: __bind(function(x1, y1, x2, y2) {
          var str;
          str = sprintf("%.2f %.2f m %.2f %.2f l S", x1 * this.scaleFactor, (this.pageSize.height - y1) * this.scaleFactor, x2 * this.scaleFactor, (this.pageSize.height - y2) * this.scaleFactor);
          this.out(str);
          return this.jsPDF;
        }, this),
